...
TOKENIZER1_PATH = "clip-vit-large-patch14"
TOKENIZER2_PATH = "CLIP-ViT-bigG-14-laion2B-39B-b160k"
...
def load_tokenizers(args: argparse.Namespace):
    ...
    for i, original_path in enumerate(original_paths):
        ...
        args.tokenizer_cache_dir = "../utils_json/"
        if args.tokenizer_cache_dir:
            #local_tokenizer_path = os.path.join(args.tokenizer_cache_dir, original_path.replace("/", "_"))
            local_tokenizer_path="/data/gongxuan/SDXL-Train/utils_json/clip-vit-large-patch14"
